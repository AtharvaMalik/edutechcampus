            ...
            <div className="flex flex-col items-center justify-center">
                <div className="relative flex justify-center">
                    ...
                    <div className="HeroHeading text-center">
                        <h1 className="text-7xl heightforedutech xl:leading-tight font-bold mt-8 xl:-mt-12">Edutech Campus</h1>
                    </div>
                </div>
                <h3 className="SubHead text-center p-10xl mt-5 xl:-mt-2 xl:p-1">Your Trusted Computer Service Center in Jagadhri</h3>
